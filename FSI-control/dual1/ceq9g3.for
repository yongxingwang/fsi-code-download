...
c .... for all integral points
      common /vceq9g3/rctr(2,2),crtr(2,2),coefd(2,5),coefc(2,5)
...
c .... by reference coordinate value
      ...
      common /ccceq9g3/ x(9),y(9),un(9),vn(9)
      external ftceq9g3
      do 100 n=1,9
      x(n)=coorr(1,n)
      y(n)=coorr(2,n)
...
c .... by reference coordinate value
      ...
      rx=refc(1)
      ry=refc(2)
      call dcoef(feceq9g3,refc,coef,coefd,2,2,2)
...
c .... coef function caculation
      implicit real*8 (a-h,o-z)
      dimension refc(2)
      common /ccceq9g3/ xa(9),ya(9),un(9),vn(9)
      common /vceq9g3/ rctr(2,2),crtr(2,2),coefd(2,5),coefc(2,5)
      common /coord/ coor(3),coora(27,3)
      x=coor(1)
      y=coor(2)
