...
c .... open gidpost.dof file
      open(2,file='fluid_gidpost.dof',form='formatted',status='old')
      read(2,*) ntime,nf
 
c .... open gidpost file
      open(1,file='fluid_gidpost',form='formatted',status='old')
...
c .... open res file
      open(3,file='fluid.flavia.res',form='formatted',status='unknown')
...
c .... open msh file
      open(3,file='fluid.flavia.msh',form='formatted',status='unknown')
