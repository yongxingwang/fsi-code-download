      ...
      write(*,*) 'memory needed = ',kna9,' in prgram ecgme'
      stop 55555
      endif
      knb0=1
      knb1=knb1+knb0
...
c      write(*,*) 'numnod,ncoor=',numnod,ncoor
      ...
      numtyp = 1
      if (it.eq.0) then
      open(11,file='fnew',form='unformatted',status='old')
      else
      open(11,file='fnew',form='unformatted',status='old')
      endif
...
2000  continue
      ...
      open(10,file='fnorm.txt',status='old', access='append') 
      write(10,*)  ff
      close(10)
 
c      open(10,file='fnorm',form='unformatted',status='unknown')
c      write(10)  ((eu(j,i),i=1,knode),j=1,kdgof)
c      close(10)
