...
ccc......  unod
      open(1,file=' ',form='unformatted',status='old')
      read(1) ((u0(i,j),j=1,numnod),i=1,noddof-1)
      close(1)
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
       ...
       do ne=1,num
       imate=node((ne-1)*nnode+nnode)	  
  
       if (imate.eq.2) then
       write(*,*) "imate == 2"
       do j=1,nnode-1
       nodj=node((ne-1)*nnode+j)
       do i=1,noddof-1
       u1(i,nodj)=0.d0
       enddo
       enddo	
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccc	  
      ...
      do j=1,numnod
      do i=1,noddof-1
      u0(i,j)=-(u0(i,j)-u1(i,j))*gamma
      enddo
      enddo
	   	  
ccc.......  ugoal
      open(10,file=' ',form='unformatted',status='old')
      write(10) ((u1(i,j),j=1,numnod),i=1,noddof-1)
      close (10)		  
ccccccccccccccccccccccccccccccccccccccccccccccccccccc 
