...
double coora[18],*coefa,*prmt,estif[324],*emass,*edamp,*eload;
int num;
...
// .... the following is the stiffness computation
        for (i=1; i<=9; ++i)
        {
            ...
            {
                jv=kvord[(j-1)*(2)+1-1];
                stif=+cu[(i-1)*(3)+2-1]*cu[(j-1)*(3)+2-1]/re
                     +cu[(i-1)*(3)+3-1]*cu[(j-1)*(3)+3-1]/re
                     +cu[(i-1)*(3)+2-1]*cu[(j-1)*(3)+2-1]/re;
        ...
        for (i=1; i<=9; ++i)
        {
            ...
            {
                jv=kvord[(j-1)*(2)+2-1];
                stif=+cu[(i-1)*(3)+3-1]*cv[(j-1)*(3)+2-1]/re;
                estif[(iv-1)*(18)+jv-1]+=stif*weigh;
            }
        }
        for (i=1; i<=9; ++i)
        {
            ...
            {
                jv=kvord[(j-1)*(2)+1-1];
                stif=+cv[(i-1)*(3)+2-1]*cu[(j-1)*(3)+3-1]/re;
                estif[(iv-1)*(18)+jv-1]+=stif*weigh;
            }
        }
        for (i=1; i<=9; ++i)
        {
            ...
            {
                jv=kvord[(j-1)*(2)+2-1];
                stif=+cv[(i-1)*(3)+2-1]*cv[(j-1)*(3)+2-1]/re
                     +cv[(i-1)*(3)+3-1]*cv[(j-1)*(3)+3-1]/re
                     +cv[(i-1)*(3)+3-1]*cv[(j-1)*(3)+3-1]/re;
                estif[(iv-1)*(18)+jv-1]+=stif*weigh;
            }
        }
