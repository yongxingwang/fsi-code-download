...
6     format (1x, 15i5)
      ...
      enddo
      close(1)	
c...wirte as unformated file coor0	  
      open (1,file='coor0',form='unformatted',status='unknown')
...
c.......open the file material parameters
      ...
      write(*,*) 'rhof:',emate((i-1)*nmate+1)
      write(*,*) 'muf:',emate((i-1)*nmate+2)	  
      enddo	  

      kemate=nmate*mmate+0.5
c....wirte as unformated file elem0
      open (3,file='elem0',form='unformatted',status='unknown')	  
      write (3) num,nnode,
...
c.......open id0 file
      open (1,file='id0',form='unformatted',status='unknown')
...
30    continue
      ...
      open(8,file='nv',status='unknown',form='unformatted')
...
c... initial condition
      ...
      enddo
      do j=1,kdgof
      u0(j,i)=upinitial(kcoor,r,j)
      enddo
      enddo
	  
c.......open u0 file
      open (1,file='ufluid',form='unformatted',status='unknown')
      write(1) ((u0(i,j),j=1,knode),i=1,kdgof-1)
      close (1)
c.......open press file
      open (1,file='press',form='unformatted',status='unknown')
      write(1) (u0(kdgof,j),j=1,knode)
      close (1)	  
...
c.......open sys file
      ...
      open (2,file='sys',form='unformatted',status='unknown')
      write(2) num,neq,numtyp,maxa,kelem,kemate
      close (2)
 
      open(2,file='diag',form='unformatted',status='unknown')
